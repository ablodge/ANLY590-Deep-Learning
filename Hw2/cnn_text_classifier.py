...
classifier.add(Conv1D(64, kernel_size=(3,), strides=1,
                 activation='relu',
                 padding='same',
                 input_shape=(100,1)))
classifier.add(Conv1D(64, kernel_size=(3,), strides=1,
...
y_pred_cnn = classifier.predict(X_test).ravel()

fpr_cnn, tpr_cnn, thresholds_cnn = roc_curve(Y_test.ravel(), y_pred_cnn)
